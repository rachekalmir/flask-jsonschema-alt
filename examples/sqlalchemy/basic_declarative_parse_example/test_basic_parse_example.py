...
from . import basic_parse_example


class BasicParseTestCase(unittest.TestCase):
    def setUp(self):
        basic_parse_example.app.config['DATABASE'] = 'sqlite:///:memory:'
        basic_parse_example.app.config['TESTING'] = True
        self.app = basic_parse_example.app.test_client()
        with basic_parse_example.app.app_context():
            basic_parse_example.init_db()
